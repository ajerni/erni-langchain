...
my_entry = st.text_input(
    "Enter a question (maybe including a calculation) and/or the magic code..."
)
...
gpt_llm = OpenAI(
    model_name="gpt-3.5-turbo", openai_api_key=st.secrets["openai_api_key"]
)
